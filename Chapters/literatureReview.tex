...
\subsection{Datasets (ISIC, PH$^2$, HAM10,000, MSK, MEDNODE, etc)}
...
\begin{table}
	...
	\begin{tabular}{|p{2.5cm}|p{10cm}|c|c|}
		...
		\\
		\hline
		7-point criteria evaluation database & 2018 & Dermoscopic & 2013 & 7-Point checklist
		\\
		\hline	
	\end{tabular}
	\caption{}
...
%Go into lots of detail about all the different diagnostic procedures used for the analysis of melanoma.
%ABCD rules, 7-point checklist, CASH
