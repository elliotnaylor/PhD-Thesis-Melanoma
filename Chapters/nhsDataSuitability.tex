...
As demonstrated in \ref(diagnosis-number) the dataset is highly inbalanced based on the diagnosis of the skin lesion with 12,875 NV and 4,522 MEL. There are only 867 AK, which has very high variance compared to other skin lesions and the sample size is unlikely for adequate detection. Others such as DF, and VASC only contains a handful of images. The difference in image samples makes the dataset only useful for testing between NV and MEL.
