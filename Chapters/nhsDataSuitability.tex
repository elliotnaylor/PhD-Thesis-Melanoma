...
There is analysis on the distribution of metadata and whether they are consistent with the literature. The reasoning for this is that a Bayesian network is used later, which analyses the distribution of data. Therefore ensuring that the data is scientifically relevant ensures the Bayesian network is correct.
